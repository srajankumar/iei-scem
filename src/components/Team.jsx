        ...
        <div className="md:px-5 py-24 mx-auto">
          ...
          <div className="flex flex-wrap -m-4">
            {sortedTeamMembers.map((item, index) => {
              // Calculate the delay based on the index (add 1 to index to avoid division by zero)
              const delay = (index % 4) * 200;
              return (
                <div key={index} className="lg:w-1/4 sm:w-1/2 w-full p-4">
                  <Slide bottom delay={delay}>
